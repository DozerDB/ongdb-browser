    ...
    <DrawerBody>
      <DrawerSection>
        <DrawerSubHeader>
          ...
          <a target="_blank" rel="noreferrer" href="http://graphfoundation.org/">
            Graph Foundation
          </a>
        </DrawerSubHeader>
      </DrawerSection>
      ...
      <DrawerSection>
        ...
        <DrawerSectionBody>
          ...
          |{' '}
          <a target="_blank" href="http://github.com/graphfoundation/ongdb">
            ONgDB
          </a>{' '}
          or{' '}
          <a
          ...
          <a href="mailto:devrel@graphfoundation.org?subject=ONgDB+Browser+feedback">
            email
          </a>
        </DrawerSectionBody>
      </DrawerSection>
